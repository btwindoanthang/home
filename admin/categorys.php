                    ...
                    <div class="modal-body">
                        <form name="frmCategory" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Pleae input!" ng-model="category.name" ng-required="true" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name2" name="name2" placeholder="Pleae input!" ng-model="category.name2" ng-required="true" >
