<!DOCTYPE html>
<!-- saved from url=(0051)http://bucketadmin.themebucket.net/fontawesome.html -->
...
<div class="nav notify-row" id="top_menu">
    ...
    <ul class="nav top-menu">
        <!-- settings start -->
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="http://bucketadmin.themebucket.net/fontawesome.html#">
            ...
            <ul class="dropdown-menu extended tasks-bar">
                ...
                <li class="external">
                    <a href="http://bucketadmin.themebucket.net/fontawesome.html#">See All Tasks</a>
                </li>
            </ul>
        </li>
        <!-- settings end -->
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="http://bucketadmin.themebucket.net/fontawesome.html#">
                        <span class="photo"><img alt="avatar" src="./public/avatar-mini.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="http://bucketadmin.themebucket.net/fontawesome.html#">
                        <span class="photo"><img alt="avatar" src="./public/avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="http://bucketadmin.themebucket.net/fontawesome.html#">
                        <span class="photo"><img alt="avatar" src="./public/avatar-mini-3.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="http://bucketadmin.themebucket.net/fontawesome.html#">See all messages</a>
                </li>
            </ul>
        </li>
        <!-- inbox dropdown end -->
            ...
            <ul class="dropdown-menu extended notification">
                ...
                <li>
                    <div class="alert alert-info clearfix">
                        ...
                        <div class="noti-info">
                            <a href="http://bucketadmin.themebucket.net/fontawesome.html#"> Server #1 overloaded.</a>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="alert alert-danger clearfix">
                        <span class="alert-icon"><i class="fa fa-bolt"></i></span>
                        <div class="noti-info">
                            <a href="http://bucketadmin.themebucket.net/fontawesome.html#"> Server #2 overloaded.</a>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="alert alert-success clearfix">
                        <span class="alert-icon"><i class="fa fa-bolt"></i></span>
                        <div class="noti-info">
                            <a href="http://bucketadmin.themebucket.net/fontawesome.html#"> Server #3 overloaded.</a>
                        </div>
                    </div>
                </li>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="http://bucketadmin.themebucket.net/fontawesome.html#">
                <img alt="" src="./public/avatar1_small.jpg">
                <span class="username">John Doe</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="http://bucketadmin.themebucket.net/fontawesome.html#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li><a href="http://bucketadmin.themebucket.net/fontawesome.html#"><i class="fa fa-cog"></i> Settings</a></li>
...
<aside>
    <div id="sidebar" class="nav-collapse">
        <!-- sidebar menu start-->            <div class="leftside-navigation" tabindex="5000" style="overflow: hidden; outline: none;">
            <ul class="sidebar-menu" id="nav-accordion">
            <li>
                <a href="http://bucketadmin.themebucket.net/index.html">
...
<li><a href="http://bucketadmin.themebucket.net/typography.html">Typography</a></li>
            ...
            <li>
                <a href="http://bucketadmin.themebucket.net/fontawesome.html" class="active">
